...
## Tagline
ดูแลระบบห้องสมุดครบทั้งสาย — ฐานข้อมูล · แอปพลิเคชัน · เซิร์ฟเวอร์
...
## Tone
- สีหลัก / บรรยากาศ: ขาวเป็นพื้นหลัก · แดงเป็นสีเน้น · ชมพูเป็นสีรองแบบเบา (ดู DECISIONS D9)
- น้ำเสียง: มืออาชีพแบบคนหน้างาน — ใช้ "ผม" ประโยคสั้น ไม่โฆษณาเกินจริง (ดู DECISIONS D8)
