...
ผมเริ่มต้นเส้นทางสายโปรแกรมมิ่งตั้งแต่สมัยเรียนที่มหาวิทยาลัยรัตนบัณฑิต และหลังสำเร็จการศึกษาก็ได้เข้าร่วมงานกับมหาวิทยาลัยวลัยลักษณ์มาจนถึงปัจจุบัน

ปัจจุบันผมทำงานเป็นโปรแกรมเมอร์ของระบบห้องสมุดอัตโนมัติ WALAI AutoLib การได้ดูแลทั้งสามชั้นของระบบ คือ Database, Application และ Infrastructure ทำให้ผมมองปัญหาได้ครบทั้งภาพ และเลือกแก้ในจุดที่ตรงสาเหตุที่สุด
